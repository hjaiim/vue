<template>
	<div class="form-input ">
        ...
        <span v-show="inputContent.length>0 && isShowClearBtn" class="close-search-btn ani-time pointer absolute"
			  :src="g.path.images+'/close-popup.png'" alt="" @click="onClick_closeBtn"></span>
		</div>
	</div>
</template>
