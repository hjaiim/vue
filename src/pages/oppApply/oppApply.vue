<template>
	<com-layout currPath="/oppapply">
		<div class="apply-wrap">
			...
			<opp-form-1 v-if="type == 1"></opp-form-1>
			<opp-form-2 v-if="type == 2"></opp-form-2>
			<opp-form-3 v-if="type == 3"></opp-form-3>
			<opp-form-4 v-if="type == 4"></opp-form-4>
			<opp-form-5 v-if="type == 5"></opp-form-5>
			<opp-form-6 v-if="type == 6"></opp-form-6>
			<opp-form-7 v-if="type == 7"></opp-form-7>
			<!---->
